...
// 设置密码：再次输入
static NSString *const GestureLockPWDTitleConfirm = @"请再次输入密码";
// 设置密码：两次密码不一致
static NSString *const GestureLockPWDDiffTitle = @"两次密码输入不一致";
// 设置密码：设置成功
static NSString *const GestureLockPWDSuccessTitle = @"密码设置成功！";

// 验证密码：普通提示文字
static NSString *const GestureLockVerifyNormalTitle = @"请滑动输入密码";
// 验证密码：密码错误
static NSString *const GestureLockVerifyErrorPwdTitle = @"密码错误";
// 验证密码：验证成功
